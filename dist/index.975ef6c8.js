...
function getData() {
    if ((0, _helpers.validatIp)(ipInput.value)) fetch(`https://geo.ipify.org/api/v2/country,city?apiKey=at_2SkQmBqz6SFsGKzAUgB9TWHWnDuTl&ipAddress=${ipInput.value}`).then((response)=>response.json()).then(setInfo);
}
...
},{"./helpers":"kEqbI","../images/icon-location.svg":"3nhAY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kEqbI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "validatIp", ()=>(0, _validateIp.validatIp));
var _validateIp = require("./validate-ip");

},{"./validate-ip":"hsVQT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hsVQT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"3nhAY":[function(require,module,exports) {
